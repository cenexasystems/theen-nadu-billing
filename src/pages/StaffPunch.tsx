      ...
      <div className="flex-1 flex flex-col px-4 py-6 max-w-2xl mx-auto w-full">
          ...
          <div className="flex flex-col items-center">
            ...
            {loading ? (
              ...
              <div className="w-full">
                ...
                {notice && !['punch_in','punch_out'].includes(notice) && <p className="text-red-600 text-sm font-bold text-center mb-4">{notice}</p>}
                ...
                <button onClick={reset} className="w-full mt-4 py-3 text-[#6B7280] font-bold text-sm hover:text-[#111111] transition-colors">← Back to staff list</button>
              </div>
            )}
          </div>
        )}
        ...
        {step === 'done' && selectedStaff && (
          <div className="flex flex-col items-center justify-center flex-1 text-center">
            ...
            <button onClick={reset} className="bg-[#E87020] text-white px-8 py-3 rounded-xl font-black hover:bg-[#C85C10] active:scale-95 transition-all">Done</button>
          </div>
        )}
      </div>
