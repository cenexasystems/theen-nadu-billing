...
export default function Dashboard() {
  ...
  const analytics = useMemo(() => {
    ...
    return {
      ...
      topWAProducts,
      topWACategories,
      // Revenue split: advance orders = service revenue, all other POS bills = product revenue
      // This ensures productRevenue + serviceRevenue always tallies with totalCompletedRevenue
      productRevenue: billableCompleted
        .filter(o => normalizeOrderType(o.order_type) !== 'advance_order')
        .reduce((s, o) => s + getOrderTotal(o), 0),
      serviceRevenue: billableCompleted
        .filter(o => normalizeOrderType(o.order_type) === 'advance_order')
        .reduce((s, o) => s + getOrderTotal(o), 0),
